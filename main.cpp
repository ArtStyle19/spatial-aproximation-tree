...
std::vector<std::pair<float, float>> S = {
    ...
    {83, 124}, {159, 776}, {278, 345}, {392, 912}, {498, 110},
    {612, 680}, {726, 204}, {843, 799}, {956, 298}, {233, 431},
    {312, 598}, {421, 217}, {547, 864}, {651, 133}, {769, 655},
    {848, 146}, {939, 883}, {174, 503}, {368, 92},  {511, 514},

    {140, 330}, {299, 709}, {472, 380}, {588, 214}, {695, 785},
    {791, 300}, {872, 578}, {964, 160}, {175, 188}, {285, 820},
    {325, 180}, {443, 720}, {566, 487}, {604, 333}, {720, 465},
    {816, 197}, {894, 653}, {915, 245}, {127, 612}, {208, 277},

    {100, 950}, {220, 120}, {300, 875}, {410, 310}, {530, 760},
    {640, 410}, {755, 120}, {880, 440}, {970, 720}, {180, 870},
    {260, 560}, {350, 160}, {470, 930}, {590, 140}, {670, 890},
    {785, 510}, {830, 310}, {905, 105}, {990, 600}, {120, 390}
...
void draw_query(float x, float y, int r) {
    // No usar glClear aquí

    // Dibuja punto de consulta
    ...
    // No llamar a glfwSwapBuffers aquí
}
...
while (!glfwWindowShouldClose(window)) {
    ...
    render(root, S);           // Dibuja árbol y puntos
    draw_query(x, y, r);       // Dibuja círculo de búsqueda encima

    glfwSwapBuffers(window);   // Un solo swap después de todo el dibujo
    glfwPollEvents();
}
